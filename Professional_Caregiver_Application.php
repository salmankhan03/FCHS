                    ...
                    <div class="col-md-12">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                ...
                                <input type="textarea" class="form-control" id="question1" name="answer1" required>
                                <div class="invalid-feedback error-box">
                                    This field is required.
                                </div>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <h6 for="question2" class=" form-label">Why do you feel you would be a good Full Care
                                    Health Services Caregiver?</h6>
                                <input type="textarea" class="form-control" id="question2" name="answer2" required>
                                <div class="invalid-feedback error-box">
                                    This field is required.
                                </div>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <h6 for="question3" class=" form-label">What is the most important thing you seek from
                                    an employer?</h6>
                                <input type="textarea" class="form-control" id="question3" name="answer3" required>
                                <div class="invalid-feedback error-box">
                                    This field is required.
                                </div>
                            </div>
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <h6 class="form-label">Are you legally authorized to work in Canada with any employer?
                                </h6>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="employer" id="personal"
                                        value="personal" required>
                                    <label class="form-check-label" for="personal">A personal car</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="employer" id="ride" value="ride"
                                        required>
                                    <label class="form-check-label" for="ride">Get a ride</label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="employer" id="public"
