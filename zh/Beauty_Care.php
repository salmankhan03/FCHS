                    ...
                    <div class="content-column col-lg-8 col-md-7 col-sm-12">
                        <div class="inner-column">
                            <ul class="mission-list">
                                <li class="text3">
                                    每個人都應該擁有讓自己身心放鬆的一天。我們的美容按摩護理服務幫助您或摯愛重新煥發活力、放鬆身心。訓練有素的美容師將提供理髮、身體按摩、皮膚護理及指甲護理等服務。
                                </li>
                                <br/>
								<li class="text3">
                                    我們的髮型服務由專業訓練的髮型師提供，將帶來無與倫比的舒適體驗。除洗髮、吹乾與造型服務外，每一次理髮都將根據您的風格和偏好量身打造。
                                </li>
                                <br/>
								<li class="text3">
                                    我們的水療護理服務將照顧您的身心健康，從身體按摩到指甲或臉部護理，您或摯愛定必感到無比舒適、恢復活力、增強自信。
								</li>
								<br/>
								<li class="text3">
                                    誠意邀請您或摯愛在一個以舒適、安寧和滿足為首要考量的空間中度過難忘的一天。請透過電話或電子郵件聯絡我們提早預約，讓我們幫您踏上美麗、提升自我和更健康的旅程。
								</li>
                            </ul>
                        </div>
                    </div>
