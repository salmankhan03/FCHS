    ...
    <div class="page-wrapper">
        ...
        <div class="container mt-5 mb-5">
            <form id="jobTitleForm" class="needs-validation" action="send-job-title-mail.php" method="post" novalidate>
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="title jobUpperSpace">健康護理助理申請</h1>
                        <input type="hidden" id="job_title" name="job_title" value="健康護理助理">
                        <div class="row mt-5">
                        ...
                        <div class="row mt-4">
                            <div class="col-md-12">
                                <h6 for="question2" class=" form-label">你認為自己為什麼適合成為健康護理助理？</h6>
